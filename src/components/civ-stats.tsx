...
export const gameStats = gamesData.reduce((stats, game) => {
  return {
    ...stats,
...
export const draftStats = draftsData.civDrafts.reduce((stats, draft) => {
  return mergeDraftStats(stats, extractDraftStats(draft.draft))
}, {});

export const civStats = allCivs
  .map(civ => ({
    name: civ,
...
export default function CivStats({ stats }) {
